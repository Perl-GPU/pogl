...
OpenGL simply via C<use OpenGL;>. If you request specific packages (such as
C<use OpenGL qw(glfunctions glconstants glutfunctions);>), you'll get 0.5
specific support.
